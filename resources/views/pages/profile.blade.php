...
@section('content')
    ...
    <!-- form styling: https://tailwindcomponents.com/component/multistep-form-with-tailwindcss-and-alpinejs -->
                    ...
                    <div class="py-10">
                        <div x-show.transition.in="step === 1">
                            <div class="mb-5 text-center">
                                ...
                                <input name="profileImage" id="fileInput" accept="image/*" class="hidden" type="file" @change="let file = document.getElementById('fileInput').files[0];
                            ...
                            <!-- Button styling from: https://tailwindcomponents.com/component/basic-contact-form-nickname -->
